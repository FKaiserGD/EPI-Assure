document.addEventListener('DOMContentLoaded', () => {
  ...
  const checkboxTermo2 = document.querySelector('#termo2');
  ...
  botaoConfirma.addEventListener('click', (event) => {
    ...
    if (checkboxes.length < 2 || !checkboxTermo2.checked || (botaoTiraFoto && !botaoTiraFoto.classList.contains('foto-tirada'))) {
